...
<div id="scrolly">
  <Step
    content={{
      subtitle: "",
      text: `In 2020, millions of people made their way across Latin America and the Caribbean, driven by the <strong>search for safety, stability, and a chance to build a future</strong>. The <span><a target= "target_blank" href="https://www.un.org/development/desa/pd/content/international-migrant-stock">UN 2020 International Migrant Stock</a></span> captured these w(e)aves of migration, showing how they thread a larger cultural fabric: Latin American and Caribbean identity.`,
    }}
  />
  <Step
    content={{
